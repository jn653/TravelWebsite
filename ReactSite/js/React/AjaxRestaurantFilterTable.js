const AjaxRestaurantFilterTable = () => {
    
    console.log("AjaxRestaurantFilterTable running");
    ...
    React.useEffect(() => {
        ...
        ajax_alt(
            ...
            function (restaurantList) {   // success function gets obj from ajax_alt
    ...
    return (
        <div>
            {error ? <div>Error: {error} </div> : <RestaurantFilterTable  list={items} heading = "My Restaurant Filter List" />}
        </div>
    );
