...
function MakeClickSortTable(title, objList, sortOrderPropName, sortIcon) {
    ...
    function addTableBody(table, objList, sortOrderPropName, filterValue) {
        ...
        jsSort(objList, sortOrderPropName);
    ...
    function makeHeader(propName, sortIcon) {
        ...
        //create div between title and table
    ...
    filterInput.onkeyup = function () {
        console.log("search filter changed to " + filterInput.value);
        addTableBody(newTable, objList, sortOrderPropName, filterInput.value);
    };
